...
{\LARGE\bf
\begin{spacing}{1.25}
Project 3 on Machine Learning, deadline December 15 (midnight), 2025
\end{spacing}
}
\end{center}
...
We enocurage you to use tools like ChatGPT or similar LLMs in writing the
report. If you use for example ChatGPT or similar LLMs, please do cite it properly and
do include your questions and answers as an addition to the
report. This includes also eventual codes you have developed with the aid of LLMs.~This can be uploaded to for example your website,
GitHub/GitLab or similar as supplemental material.

\subsection{Paths for project 3}

\paragraph{Defining the data sets to analyze yourself.}
...
\begin{enumerate}
\item Whether you end up with a regression or a classification problem, you should employ at least two of the methods we have discussed among \textbf{linear regression (including Ridge and Lasso)}, \textbf{Logistic Regression}, \textbf{Neural Networks}, \textbf{Convolution Neural Networks}, \textbf{Recurrent Neural Networks}, and \textbf{Autoencoders}. Recurrent neural networks and autoencoders are discussed during the last three weeks of lectures (November 10, 17 and 24).
\end{enumerate}

\noindent
Feel also free to use support vector machines, $k$-means, decision trees, random forests, Gradient Boosting and principal components analysis, although the latter have not been covered during the lectures. This material can be found in the lecture notes.

\begin{enumerate}
\item For project 3, you should feel free to use your own codes from projects 1 and 2, or use the available functionality of \textbf{Scikit-Learn}, \textbf{Tensorflow}, PyTorch etc. 
