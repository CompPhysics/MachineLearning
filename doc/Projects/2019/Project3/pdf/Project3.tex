...
{\LARGE\bf
\begin{spacing}{1.25}
Project 3 on Machine Learning, deadline December 15
\end{spacing}
}
\end{center}
...
\item The estimates you used and tested in projects 1 and 2 should also be included, that is the $R2$-score, \textbf{MSE}, confusion matrix, accuracy score, information gain,  cross-validation and/or bootstrap if these are relevant. 
